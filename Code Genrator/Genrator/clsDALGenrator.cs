...
namespace SQLCodeGenerator.Genrator
{
    ...
    {
        public string GenerateAddMethod(clsTableInfo table)
        {
        ...
        public string GenerateUpdateMethod(clsTableInfo table)
        {
            StringBuilder code = new StringBuilder();
        ...
        public string GenerateDeleteMethod(clsTableInfo table)
        {
            StringBuilder code = new StringBuilder();
        ...
        public string GenerateGetByIDMethod(clsTableInfo table)
        {
            StringBuilder code = new StringBuilder();
        ...
        public string GenerateGetAllMethod(clsTableInfo table)
        {
            StringBuilder code = new StringBuilder();
        ...
        public string GenerateDALClass(clsTableInfo table)
        {
            StringBuilder code = new StringBuilder();
